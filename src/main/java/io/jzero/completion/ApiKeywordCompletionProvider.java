...
public class ApiKeywordCompletionProvider extends ApiProvider {
    ...
    public ApiKeywordCompletionProvider(int priority, @Nullable AutoCompletionPolicy completionPolicy, @NotNull String... keywords) {
